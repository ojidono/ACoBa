	...
	<div>
	  ...
	  <ul class="nav nav-tabs" role="tablist" id="myTabs">
	    <li role="presentation">
	    	<a href="#semaine" aria-controls="semaine" role="tab" data-toggle="tab">Semaine</a>
	    </li>
	    <li role="presentation">
	    	<a href="#mois" aria-controls="mois" role="tab" data-toggle="tab">Mois</a>
	    </li>
	    <li role="presentation">
	    	<a href="#annee" aria-controls="annee" role="tab" data-toggle="tab">Année</a>
	    </li>
	    <form>
		    <li role="presentation">
				...
				<input type="submit" value="OK" class="btn btn-xs btn-info">
		    </li>
	    </form>
	  </ul>
