...
public class Runtime {
	...
	public static void main(String[] args) {
		try {
			...
			System.out.println(new SimpleDateFormat("yyyy-MM").parse(String.valueOf(Calendar.getInstance().get(Calendar.YEAR))+"-"+String.valueOf(Calendar.getInstance().get(Calendar.MONTH))));
